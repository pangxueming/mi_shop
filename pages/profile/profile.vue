<template>
  <view>
    ...
    <view class="position-relative d-flex a-center animated fadeIn faster" style="height: 320rpx;">
      <!-- 消息列表 -->
      <view @click="navigate('msg-list', true)" class="iconfont icon-xiaoxi position-absolute text-white" style="font-size: 50rpx;top: 75rpx;right: 20rpx;z-index: 100;"></view>

      <image src="../../static/images/profile/timg2.jpg" style="height: 320rpx;width: 100%;"></image>
    ...
    <card>
      ...
      <view class="d-flex a-center">
        <view class="flex-1 d-flex flex-column a-center j-center py-3" hover-class="bg-light-secondary" v-for="(item, index) in orders" :key="index" @click="openOrder(item)">
